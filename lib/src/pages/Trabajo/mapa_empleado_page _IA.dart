...
class EmpleadosMapaIA extends StatefulWidget {
  final String objeto;
  final double latitude;
  final double longitude;

  EmpleadosMapaIA({Key key, this.objeto, this.latitude, this.longitude})
      : super(key: key);
  @override
  _EmpleadosMapaIAState createState() => _EmpleadosMapaIAState();
}

class _EmpleadosMapaIAState extends State<EmpleadosMapaIA> {
  //lista de marcadores
  List<Marker> allMarkers = [];
  List<EmpleadosIA> _listaEmpleados = new List();
  _cargarAreas() async {
    List<EmpleadosIA> lista = await req.Peticion()
        .contratoRapido(widget.objeto, global.PERSONA.id.toString());
    setState(() {
