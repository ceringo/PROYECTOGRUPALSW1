...
import 'package:working/src/pages/Empleado/detalle_contrato.dart';

class ContratoEnEjecucion extends StatefulWidget {
  @override
  _ContratoEnEjecucionState createState() => _ContratoEnEjecucionState();
}

class _ContratoEnEjecucionState extends State<ContratoEnEjecucion> {
  List<Solicitudes> _listaSolicitudes = [];
  _cargarSolicitudes() async {
    List<Solicitudes> lista =
        await req.Peticion().misContratos(global.PERSONA.id.toString());
    setState(() {
                  ...
                  trailing: IconButton(
                    ...
                    onPressed: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => detalleContrato(
